...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        OSM(MOD_LSFT),   KC_Z,    LT(MDIA,KC_X),  KC_C,    KC_V,   KC_B,   KC_LBRC,
        ...
        KC_RBRC,  KC_N,   KC_M,  LT(SCRLL, KC_COMM),LT(MDIA, KC_DOT), KC_SLSH, OSM(MOD_RSFT),
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_HASH, KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
